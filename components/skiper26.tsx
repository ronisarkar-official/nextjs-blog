...
const Skiper26 = () => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-lg space-y-5">
        <h2 className="mt-36 text-4xl font-medium tracking-tight text-gray-900 dark:text-gray-100">
          07.09.2025 <br />
      ...
      <div className="text-gray-900 dark:text-gray-100 grid content-start justify-items-center gap-6 py-20 text-center">
        <span className="relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:from-gray-900 after:to-gray-400 dark:after:from-gray-100 dark:after:to-gray-500 after:content-['']">
...
const Options = ({
  ...
  return (
    <motion.div
      drag
      className="top-30 absolute right-1/2 flex w-[245px] translate-x-1/2 flex-col gap-3 rounded-3xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 p-3 backdrop-blur-sm lg:right-4 lg:translate-x-0"
    >
      <div className="flex items-center justify-between">
        ...
        <p className="group flex cursor-pointer items-center justify-center gap-1 rounded-lg px-2 py-1 text-sm text-gray-700 dark:text-gray-300 opacity-50">
          Options
        </p>
      </div>
      ...
      <div className="flex flex-col">
        <div className="mt-1 flex justify-between py-1">
          <p className="w-20 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 opacity-50">variant :</p>
          <div className="flex flex-wrap items-center justify-end gap-1">
            <button
              onClick={() => setVariant("circle")}
              className={cn(
                "cursor-pointer px-1 text-sm transition-opacity text-gray-900 dark:text-gray-100",
                variant === "circle"
                  ? "opacity-100"
        ...
        <div className="mt-1 flex justify-between py-1">
          <p className="w-20 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 opacity-50">blur :</p>
          <div className="flex flex-wrap items-center justify-end gap-1">
            <button
        ...
        {(variant === "circle" ||
          ...
          variant === "circle-blur") && (
          <div className="mt-1 flex justify-between py-1">
            <p className="w-20 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 opacity-50">start :</p>
            <div className="flex flex-wrap items-center justify-end gap-1">
        ...
        {variant === "gif" && (
          <div className="mt-1 flex justify-between py-1">
            <p className="w-20 text-sm text-gray-700 dark:text-gray-300 opacity-50">gif type :</p>
            <div className="flex flex-wrap items-center justify-end gap-1">
              <button
                onClick={() => {
                  setGifType("1");
        ...
        {variant === "gif" && gifType === "custom" && (
          <div className="mt-1 flex flex-col gap-1 py-1">
            <p className="text-sm text-gray-700 dark:text-gray-300 opacity-50">gif url :</p>
            <input
              type="text"
              value={gifUrl}
              onChange={(e) => setGifUrl(e.target.value)}
              placeholder="Enter GIF URL"
              className="w-full rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        )}
      </div>
